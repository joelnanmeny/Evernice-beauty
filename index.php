...
<div class="header">
  ...
  <img class=" " style="height:40px;"  src="images/evernice-logo-animated.gif" alt="">
  </a> 
</div>
      </div>
      ...
      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 slogan">
        <div class="row">
          ...
          <div class="col-lg-4 col-md-4 col-sm-6 col-xs-4" >
           ...
           <!--<a  href="index.php?lang=fr" style="color: #ffffff;font-family: 'Work Sans', sans-serif; "><b>FR</b></a>
            <a  href="index.php?lang=en" style="color: #ffffff;font-family: 'Work Sans', sans-serif; "><b>Eng</b></a>
  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 col-md-offset-3 col-lg-offset-3 col-sm-offset-3 ">
       <div class="hero-caption home animated fadeInDown" id="welcomeimg">
            <div class="row intro">
              <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 animated fadeInDown" id="welcomemsg">
                <h1 class="hero-title" style="font-style:bold;font-size: 21px;"><?php echo $lang['welcome_new']; ?></h1>
                <p class="hero-text " style="font-style:bold;color:white;" >
                  <?php echo $lang['welcome_newçdetails']; ?>
                </p>
              </div>
            </div> 
            <div class="row choix-evernice animated fadeInUp " id="btnsite">
              <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12" align="center">
                <a href="beauty-spa/evernice-beauty-spa.php" style="font-style:bold;color:white;" class="btn btn-block"> <?php echo $lang['sous_entreprise1']; ?> </a>
              </div>
             
              <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                <a href="tagidor/evernice-tagidor.php" class="btn btn-block"  style="font-style:bold;color:white;"> <?php echo $lang['sous_entreprise3']; ?> </a>
              </div>

               <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                <a href="espace-prive/evernice-espace-prive.php" style="font-style:bold;color:white;" class="btn btn-block"><?php echo $lang['sous_entreprise2']; ?>  </a>
              </div>

               
               <!-- <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                <a href="#" class="btn-block btn-inactif">  <?php //echo $lang['sous_entreprise4']; ?> </a>
              </div>-->
            </div>
        </div>
