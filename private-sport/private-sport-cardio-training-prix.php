...
<title><?php echo $lang['private_spaort_cardio_prix']; ?></title>
<!-- Bootstrap -->
      ...
      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 slogan">
        <div class="row">
          ...
          <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
            <div class="top-btn">
               <a href="private-sport-cardio-training-prix.php?lang=fr"><img class="img-fluid" src="../images/francais-flag.png" alt="Francais" title="Francais"></a>
              <a href="private-sport-cardio-training-prix.php?lang=en"><img class="img-fluid" src="../images/anglais-flag.png" alt="English" title="English"></a>
         ...
         <ul>
              ...
              <li><a href="#" title="offres" ><?php echo $lang['Offres_cap']; ?></a>
                <ul>
                  ...
                  <li class="active" ><a href="private-sport-cardio-training-prix.php" title="Cardio Training"><?php echo $lang['Liste_rix_Cardiotraining']; ?></a></li>
  ...
  <div class="container">
    <div class="row service-titre">
      <div class=" col-lg-6 col-md-6 col-sm-12 col-xs-12">
       <h3><?php echo $lang['Cardio_Training_lg']; ?>: <span><?php echo $lang['Liste_des_prix']; ?></span>
       </h3>
       </div>   
       <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 right-arrow pull-right"><a class="a-link pull-right" href="private-sport-cardio-training.php"><span><?php echo $lang['Voir_catalogue']; ?> </a></div>   
    </div>
    <div class="row">
      <div class="container">
                ...
                <div class="panel panel-default">
                  <div class="panel-heading">
                    <h4 data-toggle="collapse" data-parent="#accordion" href="#collapse1" class="panel-title expand">
                      ...
                      <a href="#" >Prix - Homme (Franc CFA)</a>
                    </h4>
                  </div>
                  <div id="collapse1" class="panel-collapse collapse">
                    <div class="panel-body">
                      <ul class="list-unstyled liste-prix">
                        <li>Coup / Shampooing / Coup d'eclat
                        ...
                        <li>Coloration simple
                        <div class="right-arrow pull-right">3,500</div></li>
                        <li>Coloration ris (bordeaux/blond)
              ...
              <div class="panel panel-default">
                <div class="panel-heading">
                  <h4 data-toggle="collapse" data-parent="#accordion1" href="#collapse7" class="panel-title expand">
                    <div class="right-arrow pull-right">+</div>
                    <a href="#" >Prix - Femmes (Franc CFA)</a>
                  </h4>
                </div>
                <div id="collapse7" class="panel-collapse collapse">
                  <div class="panel-body">
                    <ul class="list-unstyled liste-prix">
                      ...
                      <li>Shampooing brushing court
                      <div class="right-arrow pull-right">10,000</div></li>
                      <li>Shampooing brushing mi-long
                      <div class="right-arrow pull-right">12,000</div></li>
                      <li>Shampooing brushing long
                      <div class="right-arrow pull-right">15,000</div></li>
                      <li>Shampooing simple
                      <div class="right-arrow pull-right">3,000+</div></li>
                      <li>Shampooing / Rouleaux
                      <div class="right-arrow pull-right">5,000+</div></li>
                      <li>Soins masque l'Oreal
                      <div class="right-arrow pull-right">10,000</div></li>
                      <li>Soins masque Mizani
                      <div class="right-arrow pull-right">10,000</div></li>
                      <li>Soins standard
                      <div class="right-arrow pull-right">8,000+</div></li>
                      <li>Soins bio
                      <div class="right-arrow pull-right">8,000+</div></li>
                      <li>Sions produit client
                      <div class="right-arrow pull-right">8,000</div></li>
                      <li>Défrisage Mizani
                      <div class="right-arrow pull-right">20,000</div></li>
                      <li>Défrisage Affrim
                      <div class="right-arrow pull-right">20,000</div></li>
                      <li>Défrisage produit maison
                      ...
                      <li>Brushing
                      <div class="right-arrow pull-right">10,000</div></li>
                      <li>Kératine produit maison
                      <div class="right-arrow pull-right">80,000</div></li>
                      <li>Kératine produit client
  ...
  <div class="modal-dialog modal-md">
      ...
      <div class="modal-content">
          <div class="modal-header">
              ...
              <h4 class="modal-title">Beauty & Spa - RESERVATION</h4>
          </div>
          <div class="modal-body">
              <div class="row">
                  <div class="col-md-6">
                      <h3 class="reserve-info">EverNice Beauty & Spa est situé à
                          663 rue Tokoto
                          Bonapriso-Douala
                          (Près St John Plaza)<br>
                      </h3>
                      <h3>
                        Tel: 699 657 456<br>
                        Tel: 655 94 33 26
