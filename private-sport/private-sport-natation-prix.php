...
<title><?php echo $lang['private_spaort_natation_prix']; ?></title>
<!-- Bootstrap -->
      ...
      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 slogan">
        <div class="row">
          ...
          <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
            <div class="top-btn">
               <a href="private-sport-natation-prix-prix.php?lang=fr"><img class="img-fluid" src="../images/francais-flag.png" alt="Francais" title="Francais"></a>
              <a href="private-sport-natation-prix.php?lang=en"><img class="img-fluid" src="../images/anglais-flag.png" alt="English" title="English"></a>
         ...
         <ul>
              ...
              <li><a href="#" title="offres" ><?php echo $lang['Offres_cap']; ?></a>
                <ul>
                  ...
                  <li class="active"><a href="private-sport-natation-prix.php" title="Natation"><?php echo $lang['Liste_Prix_Natation']; ?></a></li>
  ...
  <div class="container">
    <div class="row service-titre">
      <div class=" col-lg-6 col-md-6 col-sm-12 col-xs-12">
       <h3><?php echo $lang['Natation_lg']; ?>: <span><?php echo $lang['Liste_des_prix']; ?></span>
       </h3>
       </div>   
       <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 right-arrow pull-right"><a class="a-link pull-right" href="private-sport-natation.php"><span><?php echo $lang['Voir_catalogue']; ?> </a></div>   
    </div>
    <div class="row">
      <div class="container">
