...
<title><?php echo $lang['private_spaort_danse']; ?></title>
<!-- Bootstrap -->
      ...
      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 slogan">
        <div class="row">
          ...
          <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
            <div class="top-btn">
               <a href="private-sport-danse.php?lang=fr"><img class="img-fluid" src="../images/francais-flag.png" alt="Francais" title="Francais"></a>
              <a href="private-sport-danse.php?lang=en"><img class="img-fluid" src="../images/anglais-flag.png" alt="English" title="English"></a>
          ...
          <ul>
              ...
              <li><a href="#" title="Service List" ><?php echo $lang['Prestations_cap']; ?></a>
                <ul>
                  ...
                  <li class="active"><a href="private-sport-danse.php" title="Danse"><?php echo $lang['Danse']; ?></a></li>
  ...
  <div class="container">
    <div class="row service-titre">
      <div class=" col-lg-6 col-md-6 col-sm-12 col-xs-12">
       <h3><?php echo $lang['Danse_lg']; ?>
        </h3>
       </div>   
       <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 right-arrow pull-right"><a class="a-link pull-right" href="private-sport-danse-prix.php"><?php echo $lang['Liste_des_prix']; ?> </a></div>   
    </div>
    <div class="row">
      <div class="container">
