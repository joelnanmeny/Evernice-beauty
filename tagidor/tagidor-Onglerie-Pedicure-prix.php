...
<title><?php echo $lang['titre_tagidor_coiffure_onglerie_prix']; ?></title>
<!-- Bootstrap -->
      ...
      <div class="row">
        ...
        <div class="row"><!-- <div class="col-lg-4 col-md-4 col-sm-4 col-xs-6">
            ...
            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
              <div class="top-btn">
            <a href="tagidor-Onglerie-Pedicure-prix.php?lang=fr"><img class="img-fluid" src="../images/francais-flag.png" alt="Francais" title="Francais"></a>&nbsp;&nbsp;
            <a href="tagidor-Onglerie-Pedicure-prix.php?lang=en"><img class="img-fluid" src="../images/anglais-flag.png" alt="English" title="English"></a>  

              <!--
               <a href="tagidor-Onglerie-Pedicure-prix.php?lang=fr"style="color: #ffffff;font-family: 'Work Sans', sans-serif; "><b>FR</b></a>
              <a href="tagidor-Onglerie-Pedicure-prix.php?lang=en"style="color: #ffffff;font-family: 'Work Sans', sans-serif; "><b>Eng</b></a>
 ...
 <!--<li><a href="../private-sport/evernice-private-sport.php" title="Evernice Private Sport&Spa"><?php //echo $lang['entreprise4']; ?></a></li>-->                
              ...
              <li><a href="#" title="Offres" ><?php echo $lang['Offres_cap']; ?></a>
                <ul>
                  ...
                  <li class="active"><a href="tagidor-Onglerie-Pedicure-prix.php" title="prix onglerie & Pedicure" ><?php echo $lang['Liste_Prix_Onglerie']; ?></a></li>
...
<div class="space-medium coiffure">
  <div class="container">
    <div class="row service-titre">
      ...
      <h3><?php echo $lang['Onglerie_pediocure']; ?>: <span><?php echo $lang['Liste_des_prix']; ?></span>
        </h3>
       </div>   
       <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 right-arrow pull-right"><a class="a-link pull-right" href="tagidor-Onglerie-Pedicure.php"><?php echo $lang['Voir_catalogue']; ?> </a></div>      
    </div>
    <div class="row">
      <div class="container">
        <section class="images-evernice slider">
          <div class="slide"><img width="400" src="../images/evernice_onglerie/onglerie1.jpg"></div>
          <div class="slide"><img width="400" src="../images/evernice_onglerie/onglerie2.jpg"></div>
          <div class="slide"><img width="400" src="../images/evernice_onglerie/onglerie3.jpg"></div>
          <div class="slide"><img width="400" src="../images/evernice_onglerie/onglerie4.jpg"></div>
          <div class="slide"><img width="400" src="../images/evernice_onglerie/onglerie6.jpg"></div>
          <div class="slide"><img width="400" src="../images/evernice_onglerie/onglerie7.jpg"></div>
          <div class="slide"><img width="400" src="../images/evernice_onglerie/onglerie8.jpg"></div>
          <div class="slide"><img width="400" src="../images/evernice_onglerie/onglerie9.jpg"></div>
        </section>
      </div>
    </div>
          ...
          <div class="panel-group catalogue" id="accordion1">
            ...
            <div class="panel panel-default">
              ...
              <div id="collapse7" class="panel-collapse collapse">
                <div class="panel-body">
                  <ul class="list-unstyled liste-prix">
                    <li><?php echo $lang['maicureprix1']; ?>
                   <div class="right-arrow pull-right"> 5,000+</div></li>
                    <li><?php echo $lang['maicureprix2']; ?>
                    <div class="right-arrow pull-right">7,000+</div></li>
                    <li><?php echo $lang['maicureprix3']; ?>
                    <div class="right-arrow pull-right">15,000+</div></li>
                    <li><?php echo $lang['maicureprix4']; ?>
                    <div class="right-arrow pull-right">6,000+</div></li>
                    <li><?php echo $lang['maicureprix5']; ?>
                    <div class="right-arrow pull-right">8,000+</div></li>
                    <li><?php echo $lang['maicureprix6']; ?>
                    <div class="right-arrow pull-right">13,000+</div></li>
                    <li><?php echo $lang['maicureprix7']; ?>
                    <div class="right-arrow pull-right">10,000+</div></li>
                    <li><?php echo $lang['maicureprix8']; ?>
                    <div class="right-arrow pull-right">3,000+</div></li>
                    <li><?php echo $lang['maicureprix9']; ?>
                    <div class="right-arrow pull-right">5,000+</div></li>
                    <li><?php echo $lang['maicureprix10']; ?>
                    <div class="right-arrow pull-right">10,000+</div></li>
                    <li><?php echo $lang['maicureprix11']; ?>
                    <div class="right-arrow pull-right">17,000+</div></li>
                    <li><?php echo $lang['maicureprix12']; ?>
                    <div class="right-arrow pull-right">12,000+</div></li>
                    <li><?php echo $lang['maicureprix13']; ?>
