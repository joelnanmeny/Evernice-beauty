...
<title><?php echo $lang['titre_tagidor_coiffure_haman_prix']; ?></title>
<!-- Bootstrap -->
      ...
      <div class="row">
        ...
        <div class="row"><!-- <div class="col-lg-4 col-md-4 col-sm-4 col-xs-6">
            ...
            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
              <div class="top-btn">
                 <a href="tagidor-hamman-turc-prix.php?lang=fr"><img class="img-fluid" src="../images/francais-flag.png" alt="Francais" title="Francais"></a>&nbsp;&nbsp;
            <a href="tagidor-hamman-turc-prix.php?lang=en"><img class="img-fluid" src="../images/anglais-flag.png" alt="English" title="English"></a>  

              <!--
                 <a href="tagidor-hamman-turc-prix.php?lang=fr"style="color: #ffffff;font-family: 'Work Sans', sans-serif; "><b>FR</b></a>
              <a href="tagidor-hamman-turc-prix.php?lang=en"style="color: #ffffff;font-family: 'Work Sans', sans-serif; "><b>Eng</b></a>
 ...
 <!--<li><a href="../private-sport/evernice-private-sport.php" title="Evernice Private Sport&Spa"><?php //echo $lang['entreprise4']; ?></a></li>-->                
              ...
              <li><a href="#" title="Offres" ><?php echo $lang['Offres_cap']; ?></a>
                <ul>
                  ...
                  <li class="active"><a href="tagidor-hamman-turc-prix.php" title="hammam turc" ><?php echo $lang['Liste_Prix_hamman']; ?></a></li>                  
...
<div class="space-medium coiffure">
  <div class="container">
    <div class="row service-titre">
      ...
      <h3><?php echo $lang['Hammam_Turc']; ?>  <span><?php echo $lang['Liste_des_prix']; ?></span>
       </h3>
       </div>   
              ...
              <div class="panel panel-default">
                <div class="panel-heading">
                  <h4 data-toggle="collapse" data-parent="#accordion" href="#collapse1" class="panel-title expand">
                    ...
                    <a href="#" ><?php echo $lang['Prix_Hammanfcfa']; ?></a>
                  </h4>
                </div>
                <div id="collapse1" class="panel-collapse collapse">
                  <div class="panel-body">
                    <ul class="list-unstyled liste-prix">
                      <li><?php echo $lang['hamman_details1']; ?>
                        <div class="right-arrow pull-right">15,000</div></li>
                        <li><?php echo $lang['hamman_details2']; ?>
                        <div class="right-arrow pull-right">15,000</div></li>
                        <li><?php echo $lang['hamman_details3']; ?>
