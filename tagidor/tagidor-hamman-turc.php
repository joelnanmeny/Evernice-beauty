...
<title><?php echo $lang['titre_tagidor_coiffure_haman']; ?></title>
<!-- Bootstrap -->
        ...
        <div class="row"><!-- <div class="col-lg-4 col-md-4 col-sm-4 col-xs-6">
            ...
            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
              <div class="top-btn">
                  ...
                  <a href="tagidor-hamman-turc.php?lang=fr"><img class="img-fluid" src="../images/francais-flag.png" alt="Francais" title="Francais"></a>&nbsp;&nbsp;
            <a href="tagidor-hamman-turc.php?lang=en"><img class="img-fluid" src="../images/anglais-flag.png" alt="English" title="English"></a>  

              <!--
                 <a href="tagidor-hamman-turc.php?lang=fr"style="color: #ffffff;font-family: 'Work Sans', sans-serif; "><b>FR</b></a>
              <a href="tagidor-hamman-turc.php?lang=en"style="color: #ffffff;font-family: 'Work Sans', sans-serif; "><b>Eng</b></a>
 ...
 <!--<li><a href="../private-sport/evernice-private-sport.php" title="Evernice Private Sport&Spa"><?php //echo $lang['entreprise4']; ?></a></li>-->                
               ...
               <li><a href="#" title="Service List" ><?php echo $lang['Prestations_cap']; ?></a>
                <ul >
                  ...
                  <li class="active"><a href="tagidor-hamman-turc.php" title="hammam turc"><?php echo $lang['Hammam_Turc']; ?></a></li>
...
<div class="space-medium coiffure">
  <div class="container">
    <div class="row service-titre">
      ...
      <h3><?php echo $lang['Hammam_Turc']; ?> 
       </h3>
       </div>   
       <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 right-arrow pull-right"><a class="a-link pull-right" href="tagidor-hamman-turc-prix.php"><?php echo $lang['Liste_des_prix']; ?> </a></div>   
    </div>
      <div class="row">
      <div class="container">
        <section class="images-evernice slider">
          <div class="slide"><img width="400" src="../images/hamman/hamman1.jpg"></div>
          <div class="slide"><img width="400" src="../images/hamman/hamman2.jpg"></div>
          <div class="slide"><img width="400" src="../images/hamman/hamman3.jpg"></div>
          <div class="slide"><img width="400" src="../images/hamman/hamman4.jpg"></div>
          <div class="slide"><img width="400" src="../images/hamman/hamman5.jpg"></div>
          <div class="slide"><img width="400" src="../images/hamman/hamman6.jpg"></div>
          <div class="slide"><img width="400" src="../images/hamman/hamman7.jpg"></div>
          <div class="slide"><img width="400" src="../images/hamman/hamman8.jpg"></div>
        </section>
      </div>
    </div>
              ...
              <div class="panel panel-default">
                <div class="panel-heading">
                  <h4 data-toggle="collapse" data-parent="#accordion" href="#collapse1" class="panel-title expand">
                    ...
                    <a href="#" ><?php echo $lang['hamman1']; ?></a>
                  </h4>
                </div>
                <div id="collapse1" class="panel-collapse collapse">
                  <div class="panel-body">
                   <?php echo $lang['details_hamman1']; ?>
                  </div>
            ...
            <div class="panel panel-default">
              <div class="panel-heading">
                <h4 data-toggle="collapse" data-parent="#accordion1" href="#collapse7" class="panel-title expand">
                  <div class="right-arrow pull-right">+</div>
                  <a href="#" ><?php echo $lang['hamman2']; ?></a>
                </h4>
              </div>
              <div id="collapse7" class="panel-collapse collapse">
                <div class="panel-body">
                   <?php echo $lang['details_hamman2']; ?>
                </div>
                     <div class="visitbtn hidden-xs hidden-sm"><button class="btn btn-primary btn-sm btn-block" data-toggle="modal" data-target="#mediumModal"><span><i class="fa fa-phone"></i></span> <?php echo $lang['Reservez']; ?> </button></div>
                    <div class="visitbtn hidden-lg hidden-md"><a class="btn btn-primary btn-sm btn-block" href="<?php echo $lang['phone_tagidor']; ?>" data-rel="external"><span><i class="fa fa-phone"></i></span> <?php echo $lang['Appelez']; ?></a></div>
              </div>
