...
<title><?php echo $lang['titre_tagidor_trainning_sport']; ?></title>
<!-- Bootstrap -->
      ...
      <div class="row">
        ...
        <div class="row"><!-- <div class="col-lg-4 col-md-4 col-sm-4 col-xs-6">
            ...
            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
              <div class="top-btn">
                 <a href="tagidor-sport-training.php?lang=fr"style="color: #ffffff;font-family: 'Work Sans', sans-serif; "><b>FR</b></a>
              <a href="tagidor-sport-training.php?lang=en"style="color: #ffffff;font-family: 'Work Sans', sans-serif; "><b>Eng</b></a>
 ...
 <!--<li><a href="../private-sport/evernice-private-sport.php" title="Evernice Private Sport&Spa"><?php //echo $lang['entreprise4']; ?></a></li>-->                
               ...
               <li><a href="#" title="Service List" ><?php echo $lang['Prestations_cap']; ?></a>
                <ul >
                  ...
                  <li class="active"><a href="tagidor-sport-training.php" title="Sport & Training"> <?php echo $lang['Sport_trainning']; ?></a></li>
                </ul>
              </li>
              <li><a href="#" title="Offres" ><?php echo $lang['Offres_cap']; ?></a>
                <ul>
                  ...
                  <li><a href="tagidor-sport-training-prix.php" title="Sport & Training" ><?php echo $lang['Liste_Prix_sport']; ?></a></li>
                </ul>
              </li>
...
<div class="space-medium coiffure">
  <div class="container">
    <div class="row service-titre">
      ...
      <h3><?php echo $lang['Sport_trainning_gr']; ?> 
       </h3>
       </div>   
       <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 right-arrow pull-right"><a class="a-link pull-right" href="tagidor-sport-training-prix.php"><?php echo $lang['Liste_des_prix']; ?> </a></div>   
    </div>
      <div class="row">
      <div class="container">
