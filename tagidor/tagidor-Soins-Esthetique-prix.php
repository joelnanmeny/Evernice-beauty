...
<title><?php echo $lang['titre_tagidor_coiffure_soins_esthetiques_prix']; ?></title>
<!-- Bootstrap -->
      ...
      <div class="row">
        ...
        <div class="row"><!-- <div class="col-lg-4 col-md-4 col-sm-4 col-xs-6">
            ...
            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
              ...
              <a href="tagidor-Soins-Esthetique-prix.php?lang=fr"><img class="img-fluid" src="../images/francais-flag.png" alt="Francais" title="Francais"></a>&nbsp;&nbsp;
            <a href="tagidor-Soins-Esthetique-prix.php?lang=en"><img class="img-fluid" src="../images/anglais-flag.png" alt="English" title="English"></a>  

              <!--
                <a href="tagidor-Soins-Esthetique-prix.php?lang=fr"style="color: #ffffff;font-family: 'Work Sans', sans-serif; "><b>FR</b></a>
              <a href="tagidor-Soins-Esthetique-prix.php?lang=en"style="color: #ffffff;font-family: 'Work Sans', sans-serif; "><b>Eng</b></a>
 ...
 <!--<li><a href="../private-sport/evernice-private-sport.php" title="Evernice Private Sport&Spa"><?php //echo $lang['entreprise4']; ?></a></li>-->                
              ...
              <li><a href="#" title="Offres" ><?php echo $lang['Offres_cap']; ?></a>
                <ul>
                  ...
                  <li class="active"><a href="tagidor-Soins-Esthetique-prix.php" title="prix soins & Esthetiques" ><?php echo $lang['Liste_Prix_Soins']; ?></a></li>
...
<div class="space-medium coiffure">
  <div class="container">
    <div class="row service-titre">
       ...
       <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 right-arrow pull-right"><a class="a-link pull-right" href="tagidor-Soins-Esthetique.php"><?php echo $lang['Voir_catalogue']; ?></a></div>   
    </div>
    <div class="row">
      <div class="container">
                    ...
                    <ul class="list-unstyled liste-prix">
                      <li><?php echo $lang['soinshomme1']; ?>
                        ...
                        <div class="right-arrow pull-right">15,000</div></li>
                         <li><?php echo $lang['soinshomme22']; ?>
                        <div class="right-arrow pull-right">25,000</div></li>
                        <li><?php echo $lang['soinshomme23']; ?>
                        ...
                        <div class="right-arrow pull-right">20,000</div></li>
                        <li><?php echo $lang['soinshomme06']; ?>
                        <div class="right-arrow pull-right">35,000</div></li>
                        <li><?php echo $lang['soinshomme07']; ?>
                        ...
                        <div class="right-arrow pull-right">5,000</div></li>
                         ...
                         <li><?php echo $lang['soinshomme24']; ?>
                        <div class="right-arrow pull-right">10,000</div></li>

                        <li><?php echo $lang['soinshomme015']; ?>
                        <div class="right-arrow pull-right">20,000</div></li>
                        <li><?php echo $lang['soinshomme016']; ?>
                        <div class="right-arrow pull-right">15,000</div></li>
