...
<title><?php echo $lang['titre_tagidor_coiffure_haman_piscine_jacuzi_prix']; ?></title>
<!-- Bootstrap -->
...
<body class="animsition">
        ...
        <div class="row"><!-- <div class="col-lg-4 col-md-4 col-sm-4 col-xs-6">
            ...
            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
              <div class="top-btn">
                ...
                <a href="tagidor-piscine-jacuzzi-prix.php?lang=fr"><img class="img-fluid" src="../images/francais-flag.png" alt="Francais" title="Francais"></a>&nbsp;&nbsp;
            <a href="tagidor-piscine-jacuzzi-prix.php?lang=en"><img class="img-fluid" src="../images/anglais-flag.png" alt="English" title="English"></a>  

              <!--
                 <a href="tagidor-piscine-jacuzzi-prix.php?lang=fr"style="color: #ffffff;font-family: 'Work Sans', sans-serif; "><b>FR</b></a>
              <a href="tagidor-piscine-jacuzzi-prix.php?lang=en"style="color: #ffffff;font-family: 'Work Sans', sans-serif; "><b>Eng</b></a>
 ...
 <!--<li><a href="../private-sport/evernice-private-sport.php" title="Evernice Private Sport&Spa"><?php //echo $lang['entreprise4']; ?></a></li>-->                
              ...
              <li><a href="#" title="Offres" ><?php echo $lang['Offres_cap']; ?></a>
                <ul>
                   <li class="active"><a href="tagidor-piscine-jacuzzi-prix.php" title="piscine & Jacuzzi" ><?php echo $lang['Liste_Prix_piscine']; ?></a></li>
...
<div class="space-medium coiffure">
  <div class="container">
    <div class="row service-titre">
      ...
      <h3><?php echo $lang['Piscine_Jacuzzi']; ?>  <span><?php echo $lang['Liste_des_prix']; ?></span>
       </h3>
       </div>   
      ...
      <section class="images-evernice slider">
          <div class="slide"><img width="400" src="../images/piscine/piscine (1).jpg"></div>
          <div class="slide"><img width="400" src="../images/piscine/piscine (2).jpg"></div>
          <div class="slide"><img width="400" src="../images/piscine/piscine (3).jpg"></div>
          <div class="slide"><img width="400" src="../images/piscine/piscine (4).jpg"></div>
          <div class="slide"><img width="400" src="../images/piscine/piscine (5).jpg"></div>
          <div class="slide"><img width="400" src="../images/piscine/piscine (6).jpg"></div>
          <div class="slide"><img width="400" src="../images/piscine/piscine (7).jpg"></div>
          <div class="slide"><img width="400" src="../images/piscine/piscine (8).jpg"></div>
          <div class="slide"><img width="400" src="../images/piscine/piscine (9).jpg"></div>
          <div class="slide"><img width="400" src="../images/piscine/piscine (10).jpg"></div>
          <div class="slide"><img width="400" src="../images/piscine/piscine (11).jpg"></div>
          <div class="slide"><img width="400" src="../images/piscine/piscine (12).jpg"></div>
          <div class="slide"><img width="400" src="../images/piscine/piscine (13).jpg"></div>
          <div class="slide"><img width="400" src="../images/piscine/piscine (14).jpg"></div>
        </section>
      </div>
    </div>
              ...
              <div class="panel panel-default">
                <div class="panel-heading">
                  <h4 data-toggle="collapse" data-parent="#accordion" href="#collapse1" class="panel-title expand">
                    ...
                    <a href="#" ><?php echo $lang['Prix_piscinefcfa']; ?></a>
                  </h4>
                </div>
                <div id="collapse1" class="panel-collapse collapse">
                  <div class="panel-body">
                    <ul class="list-unstyled liste-prix">
                      <li><?php echo $lang['piscine_details1']; ?>
                        <div class="right-arrow pull-right">4,000</div></li>
                        <li><?php echo $lang['piscine_details2']; ?>
                        <div class="right-arrow pull-right">5,000</div></li>
                        <li><?php echo $lang['piscine_details3']; ?>
                        <div class="right-arrow pull-right">10,000</div></li>

                        <li><?php echo $lang['piscine_details4']; ?>
                        <div class="right-arrow pull-right">18,000</div></li>
                        <li><?php echo $lang['piscine_details5']; ?>
                        <div class="right-arrow pull-right">22,000</div></li>
                        <li><?php echo $lang['piscine_details6']; ?>
                        <div class="right-arrow pull-right">22,000</div></li>
                        <li><?php echo $lang['piscine_details7']; ?>
                        <div class="right-arrow pull-right">27,000</div></li>
