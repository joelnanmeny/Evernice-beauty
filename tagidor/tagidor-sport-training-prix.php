...
<title><?php echo $lang['titre_tagidor_trainning_sport_prix']; ?></title>
<!-- Bootstrap -->
...
<body class="animsition">
      ...
      <div class="row">
        ...
        <div class="row"><!-- <div class="col-lg-4 col-md-4 col-sm-4 col-xs-6">
            ...
            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
              <div class="top-btn">
                 <a href="tagidor-sport-training-prix.php?lang=fr"style="color: #ffffff;font-family: 'Work Sans', sans-serif; "><b>FR</b></a>
              <a href="tagidor-sport-training-prix.php?lang=en"style="color: #ffffff;font-family: 'Work Sans', sans-serif; "><b>Eng</b></a>
 ...
 <!--<li><a href="../private-sport/evernice-private-sport.php" title="Evernice Private Sport&Spa"><?php //echo $lang['entreprise4']; ?></a></li>-->                
               ...
               <li><a href="#" title="Service List" ><?php echo $lang['Prestations_cap']; ?></a>
                <ul >
                  <li  ><a href="tagidor-coiffures.php" title="Coiffures"><?php echo $lang['Coiffures']; ?></a></li>
                  ...
                  <li ><a href="tagidor-sport-training.php" title="Sport & Training"> <?php echo $lang['Sport_trainning']; ?></a></li>
                </ul>
              </li>
              <li><a href="#" title="Offres" ><?php echo $lang['Offres_cap']; ?></a>
                <ul>
                  ...
                  <li class="active"><a href="tagidor-sport-training-prix.php" title="Sport & Training" ><?php echo $lang['Liste_Prix_sport']; ?></a></li>
                </ul>
              </li>
...
<div class="space-medium coiffure">
  <div class="container">
    <div class="row service-titre">
      ...
      <h3><?php echo $lang['Sport_trainning_gr']; ?>  <span><?php echo $lang['Liste_des_prix']; ?></span>
       </h3>
       </div>   
