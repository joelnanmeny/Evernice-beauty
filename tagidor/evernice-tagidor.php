...
<title><?php echo $lang['titre_tagidor']; ?></title>
<!-- Bootstrap -->
        ...
        <div class="row"><!-- <div class="col-lg-4 col-md-4 col-sm-4 col-xs-6">
            ...
            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
              <div class="top-btn">
               ...
               <a href="evernice-tagidor.php?lang=fr"><img class="img-fluid" src="../images/francais-flag.png" alt="Francais" title="Francais"></a>&nbsp;&nbsp;
            <a href="evernice-tagidor.php?lang=en"><img class="img-fluid" src="../images/anglais-flag.png" alt="English" title="English"></a>  

              <!-- <a href="evernice-tagidor.php?lang=fr"style="color: #ffffff;font-family: 'Work Sans', sans-serif; "><b>FR</b></a>
              <a href="evernice-tagidor.php?lang=en"style="color: #ffffff;font-family: 'Work Sans', sans-serif; "><b>Eng</b></a>
  ...
  <div class="container bienvenue">
    <div class="row evernice-en">
      <div class="evernice-title col-lg-12 col-md-12 col-sm-12 col-xs-12">
        ...
        <?php echo $lang['TAGIDOR_BY_EVERNICE_titre']; ?> <small> <b> ♦  <?php echo $lang['TAGIDOR_BY_EVERNICE_details']; ?></b></small>
          </div>
       </div>      
    </div>
    <div class="row">
        ...
        <div class="row">
          <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="about-info mb40 bg-light pinside10">
              ...
              <p> <?php echo $lang['details_tagidor']; ?><br><?php echo $lang['details_tagidor1']; ?></p>
              <div class="text-right"><a href="tagidor-contact.php" class="btn-link"><?php echo $lang['Contactez_Nous']; ?></a></div>
            </div>
          </div>
                  ...
                  <div class="panel-group evernice-services" id="accordion">
                    ...
                    <div class="panel panel-default">
                      <div class="panel-heading">
                        <h4 data-toggle="collapse" data-parent="#accordion" href="#collapse1" class="panel-title expand">
                          ...
                          <a href="#" ><?php echo $lang['Piscine_Jacuzzi_gr']; ?></a>
                        </h4>
                      </div>
                      <div id="collapse1" class="panel-collapse collapse">
                         <div class="panel-body">
                        <a href="tagidor-piscine-jacuzzi.php" class="btn-link"><span><i class="fa fa-arrow-right"></i></span> <?php echo $lang['Visitez_le_Catalogue']; ?> </a><br>
                        <!-- <p class="mb40">Cras auctor laoreet duid temsem cursus sedenean elementumest vitae.</p> -->
                        <a href="tagidor-piscine-jacuzzi-prix.php" class="btn-link"><span><i class="fa fa-arrow-right"></i></span> <?php echo $lang['Liste_des_prix']; ?></a>
                       </div>
                    ...
                    <div class="panel panel-default">
                     <div class="panel-heading">
                       <h4 data-toggle="collapse" data-parent="#accordion" href="#collapse2" class="panel-title expand">
                         <div class="right-arrow pull-right">+</div>
                         <a href="#" ><?php echo $lang['Hammam_Tur_gr']; ?></a>
                       </h4>
                     </div>
                     <div id="collapse2" class="panel-collapse collapse">
                       <div class="panel-body">
                          
                        <a href="tagidor-hamman-turc.php" class="btn-link"><span><i class="fa fa-arrow-right"></i></span> <?php echo $lang['Visitez_le_Catalogue']; ?></a><br>
                        <!-- <p class="mb40">Cras auctor laoreet duid temsem cursus sedenean elementumest vitae.</p> -->
                        <a href="tagidor-hamman-turc-prix.php" class="btn-link"><span><i class="fa fa-arrow-right"></i></span> <?php echo $lang['Liste_des_prix']; ?></a>
                     ...
                     <div class="panel panel-default">
                       ...
                       <div id="collapse3" class="panel-collapse collapse">
                         <div class="panel-body">
                          <a href="tagidor-Soins-Esthetique.php" class="btn-link"> <span><i class="fa fa-arrow-right"></i></span> <?php echo $lang['Visitez_le_Catalogue']; ?> </a><br>
                          <!-- <p class="mb40">Cras auctor laoreet duid temsem cursus sedenean elementumest vitae.</p> -->
                          <a href="tagidor-Soins-Esthetique-prix.php" class="btn-link"> <span><i class="fa fa-arrow-right"></i></span> <?php echo $lang['Liste_des_prix']; ?></a>
                         </div>
                    ...
                    <div class="panel panel-default">
                      ...
                      <div id="collapse4" class="panel-collapse collapse">
                        <div class="panel-body">
                        <a href="tagidor-Onglerie-Pedicure.php" class="btn-link"><span><i class="fa fa-arrow-right"></i></span> <?php echo $lang['Visitez_le_Catalogue']; ?> </a><br>
                        <!-- <p class="mb40">Cras auctor laoreet duid temsem cursus sedenean elementumest vitae.</p> -->
                        <a href="tagidor-Onglerie-Pedicure-prix.php" class="btn-link"><span><i class="fa fa-arrow-right"></i></span> <?php echo $lang['Liste_des_prix']; ?></a>
                       </div>
                    ...
                    <div class="panel panel-default">
                     ...
                     <div class="panel-body">
                      ...
                      <a href="tagidor-coiffures.php" class="btn-link"><span><i class="fa fa-arrow-right"></i></span> <?php echo $lang['Visitez_le_Catalogue']; ?></a><br>
                      <!-- <p class="mb40">Cras auctor laoreet duid temsem cursus sedenean elementumest vitae.</p> -->
                    <a href="tagidor-coiffures-prix.php" class="btn-link"><span><i class="fa fa-arrow-right"></i></span> <?php echo $lang['Liste_des_prix']; ?> </a>
