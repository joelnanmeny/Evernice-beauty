...
<title><?php echo $lang['spac_coiffure_prix']; ?></title>
<!-- Bootstrap -->
      ...
      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 slogan">
        <div class="row">
          ...
          <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
            <div class="top-btn">
              <a href="beauty-spa-Onglerie-Pedicure-prix.php?lang=fr"><img class="img-fluid" src="../images/francais-flag.png" alt="Francais" title="Francais"></a>&nbsp;&nbsp;
            <a href="beauty-spa-Onglerie-Pedicure-prix.php?lang=en"><img class="img-fluid" src="../images/anglais-flag.png" alt="English" title="English"></a>  

              <!-- 
               <a  href="beauty-spa-Onglerie-Pedicure-prix.php?lang=fr" style="color: #ffffff;font-family: 'Work Sans', sans-serif; "><b>FR</b></a>
               <a  href="beauty-spa-Onglerie-Pedicure-prix.php?lang=en" style="color: #ffffff;font-family: 'Work Sans', sans-serif; "><b>Eng</b></a>
             ...
             <ul >
              ...
              <li><a href="#" title="Blog" ><?php echo $lang['Offres_cap']; ?></a>
                <ul>
                  ...
                  <li class="active"><a href="beauty-spa-Onglerie-Pedicure-prix.php" title="prix onglerie & Pedicure" class="animsition-link"><?php echo $lang['Liste_Prix_Onglerie']; ?></a></li>
  ...
  <div class="container">
    <div class="row service-titre">
      ...
      <h3><?php echo $lang['Onglerie_pediocure']; ?>: <span><?php echo $lang['Liste_des_prix']; ?></span>
       ...
       <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 right-arrow pull-right"><a class="a-link pull-right" href="beauty-spa-Onglerie-Pedicure.php"><?php echo $lang['Voir_catalogue']; ?> </a></div>   
    </div>
    <div class="row">
      <div class="container">
        <section class="images-evernice slider">
          <div class="slide"><img width="400" src="../images/Evernice_images/Ongl_simple/image1.jpg"></div>
          <div class="slide"><img width="400" src="../images/Evernice_images/Ongl_simple/image2.jpg"></div>
          <div class="slide"><img width="400" src="../images/Evernice_images/Ongl_simple/image3.jpg"></div>
          <div class="slide"><img width="400" src="../images/Evernice_images/Ongl_simple/image4.jpg"></div>
          <div class="slide"><img width="400" src="../images/Evernice_images/Ongl_simple/image5.jpg"></div>
          <div class="slide"><img width="400" src="../images/Evernice_images/Ongl_simple/image6.jpg"></div>
          <div class="slide"><img width="400" src="../images/Evernice_images/Ongl_simple/image7.jpg"></div>
