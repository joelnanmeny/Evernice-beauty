...
<title><?php echo $lang['titrebeauty']; ?></title>
<!-- Bootstrap -->
        ...
        <div class="row">
          <!-- <div class="col-lg-4 col-md-4 col-sm-4 col-xs-6">
            ...
            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
              <div class="top-btn">
                <a href="evernice-beauty-spa.php?lang=fr"><img class="img-fluid" src="../images/francais-flag.png" alt="Francais" title="Francais"></a>&nbsp;&nbsp;
                <a href="evernice-beauty-spa.php?lang=en"><img class="img-fluid" src="../images/anglais-flag.png" alt="English" title="English"></a>  

              <!-- 
                <a  href="evernice-beauty-spa.php?lang=fr" style="color: #ffffff;font-family: 'Work Sans', sans-serif; "><b>FR</b></a>
                <a  href="evernice-beauty-spa.php?lang=en" style="color: #ffffff;font-family: 'Work Sans', sans-serif; "><b>Eng</b></a>
  ...
  <div class="container bienvenue">
    <div class="row evernice-en">
      <div class="evernice-title col-lg-12 col-md-12 col-sm-12 col-xs-12">
        ...
        <?php echo $lang['EVERNICE_beauty_titre']; ?> <small> <b> ♦  <?php echo $lang['EVERNICE_beauty__details']; ?></b></small>  
        </div>
       </div>      
    </div>
    <div class="row">
      <div class="row">
        <div class="container">
          ...
          <div class="slide"><img width="400" src="../images/Evernice_images/Accueil_simple/image1.jpg"></div>
          <div class="slide"><img width="400" src="../images/Evernice_images/Accueil_simple/image2.jpg"></div>
          <div class="slide"><img width="400" src="../images/Evernice_images/Accueil_simple/image3.jpg"></div>
          <div class="slide"><img width="400" src="../images/Evernice_images/Accueil_simple/image4.jpg"></div>
          <div class="slide"><img width="400" src="../images/Evernice_images/Accueil_simple/image5.jpg"></div>
          <div class="slide"><img width="400" src="../images/Evernice_images/Accueil_simple/image6.jpg"></div>
        </section>
        </div>
      </div>
        ...
        <div class="row">
          <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="about-info mb40 bg-light pinside10">
              ...
              <p><?php echo $lang['details1']; ?></p>
              <p><?php echo $lang['details2']; ?>
                </p>
              <div class="text-right"><a href="beauty-spa-contact.php" class="btn-link"><?php echo $lang['Contactez_Nous']; ?></a></div>
            </div>
          </div>
                  ...
                  <div class="panel-group evernice-services" id="accordion">
                    ...
                    <div class="panel panel-default">
                      ...
                      <div id="collapse1" class="panel-collapse collapse">
                        <div class="panel-body">
                            ...
                            <a href="beauty-spa-coiffures.php" class="btn-link"><span><i class="fa fa-arrow-right"></i></span> <?php echo $lang['Visitez_le_Catalogue']; ?> </a><br>
                            <!-- <p class="mb40">Cras auctor laoreet duid temsem cursus sedenean elementumest vitae.</p> -->
                            <a href="beauty-spa-coiffures-prix.php" class="btn-link"><span><i class="fa fa-arrow-right"></i></span> <?php echo $lang['Liste_des_prix']; ?> </a>
                    ...
                    <div class="panel panel-default">
                     ...
                     <div id="collapse2" class="panel-collapse collapse">
                       <div class="panel-body">
                        <a href="beauty-spa-Onglerie-Pedicure.php" class="btn-link"><span><i class="fa fa-arrow-right"></i></span> <?php echo $lang['Visitez_le_Catalogue']; ?> </a><br>
                        <!-- <p class="mb40">Cras auctor laoreet duid temsem cursus sedenean elementumest vitae.</p> -->
                        <a href="beauty-spa-Onglerie-Pedicure-prix.php" class="btn-link"><span><i class="fa fa-arrow-right"></i></span> <?php echo $lang['Liste_des_prix']; ?></a>
                       </div>
                     ...
                     <div class="panel panel-default">
                       ...
                       <div id="collapse3" class="panel-collapse collapse">
                         <div class="panel-body">
                          <a href="beauty-spa-Soins-Esthetique.php" class="btn-link"> <span><i class="fa fa-arrow-right"></i></span> <?php echo $lang['Visitez_le_Catalogue']; ?></a><br>
                          <!-- <p class="mb40">Cras auctor laoreet duid temsem cursus sedenean elementumest vitae.</p> -->
                          <a href="beauty-spa-Soins-Esthetique-prix.php" class="btn-link"> <span><i class="fa fa-arrow-right"></i></span> <?php echo $lang['Liste_des_prix']; ?></a>
                         </div>
