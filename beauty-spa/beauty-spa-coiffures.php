...
<title><?php echo $lang['spac_onglerie_pedicure_titre']; ?></title>
<!-- Bootstrap -->
      ...
      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 slogan">
        <div class="row">
          ...
          <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
            <div class="top-btn">
              <a href="beauty-spa-coiffures.php?lang=fr"><img class="img-fluid" src="../images/francais-flag.png" alt="Francais" title="Francais"></a>&nbsp;&nbsp;
            <a href="beauty-spa-coiffures.php?lang=en"><img class="img-fluid" src="../images/anglais-flag.png" alt="English" title="English"></a>  

              <!-- 
              <a  href="beauty-spa-coiffures.php?lang=fr" style="color: #ffffff;font-family: 'Work Sans', sans-serif; "><b>FR</b></a>
               <a  href="beauty-spa-coiffures.php?lang=en" style="color: #ffffff;font-family: 'Work Sans', sans-serif; "><b>Eng</b></a>
        ...
        <div class="navigation" id="navigation" >
          ...
          <ul >
              ...
              <li><a href="#" title="Service List" ><?php echo $lang['Prestations_cap']; ?></a>
                <ul>
                  <li class="active" ><a href="beauty-spa-coiffures.php" title="Coiffures"><?php echo $lang['Coiffures']; ?></a></li>
  ...
  <div class="container">
    <div class="row service-titre">
      ...
      <h3><?php echo $lang['Coiffures']; ?>
       ...
       <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 right-arrow pull-right"><a class="a-link pull-right" href="beauty-spa-coiffures-prix.php"><?php echo $lang['Liste_des_prix']; ?></a></div>   
    </div> 
    <div class="row">
      <div class="container">
      <section class="images-evernice slider">
          <div class="slide"><img width="400" src="../images/Evernice_images/Coiffure_simple/image1.jpg"></div>
          <div class="slide"><img width="400" src="../images/Evernice_images/Coiffure_simple/image2.jpg"></div>
          <div class="slide"><img width="400" src="../images/Evernice_images/Coiffure_simple/image3.jpg"></div>
          <div class="slide"><img width="400" src="../images/Evernice_images/Coiffure_simple/image4.jpg"></div>
          <div class="slide"><img width="400" src="../images/Evernice_images/Coiffure_simple/image5.jpg"></div>
          <div class="slide"><img width="400" src="../images/Evernice_images/Coiffure_simple/image6.jpg"></div>
          <div class="slide"><img width="400" src="../images/Evernice_images/Coiffure_simple/image7.jpg"></div>
            ...
            <div class="panel panel-default">
             ...
             <div class="panel panel-default">
               ...
               <div id="collapse18" class="panel-collapse collapse">
                 <div class="panel-body">
                   <?php echo $lang['details_coiffure15']; ?>
                    </div>
                     <div class="visitbtn hidden-xs hidden-sm"><button class="btn btn-primary btn-sm btn-block" data-toggle="modal" data-target="#mediumModal"><span><i class="fa fa-phone"></i></span> <?php echo $lang['Reservez']; ?> </button></div>
                  <div class="visitbtn hidden-lg hidden-md"><a class="btn btn-primary btn-sm btn-block" href="<?php echo $lang['phone']; ?>" data-rel="external"><span><i class="fa fa-phone"></i></span> <?php echo $lang['Appelez']; ?></a></div>
