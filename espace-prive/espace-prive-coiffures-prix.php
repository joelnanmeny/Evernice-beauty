...
<title><?php echo $lang['titre_prive_prix_coiffure']; ?></title>
<!-- Bootstrap -->
      ...
      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 slogan">
        <div class="row">
          ...
          <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
            <div class="top-btn">
              <a href="espace-prive-coiffures-prix.php?lang=fr"><img class="img-fluid" src="../images/francais-flag.png" alt="Francais" title="Francais"></a>&nbsp;&nbsp;
            <a href="espace-prive-coiffures-prix.php?lang=en"><img class="img-fluid" src="../images/anglais-flag.png" alt="English" title="English"></a>  

              <!-- 
              <a  href="espace-prive-coiffures-prix.php?lang=fr" style="color: #ffffff;font-family: 'Work Sans', sans-serif; "><b>FR</b></a>
            <a  href="espace-prive-coiffures-prix.php?lang=en" style="color: #ffffff;font-family: 'Work Sans', sans-serif; "><b>Eng</b></a>
        ...
        <div class="navigation" id="navigation" >
           <ul >
              ...
              <li><a href="#" title="Blog" ><?php echo $lang['Offres_cap']; ?></a>
                <ul>
                  <li class="active" ><a href="espace-prive-coiffures-prix.php" title="prix coiffure" class="animsition-link"><?php echo $lang['Liste_Prix_Coiffure']; ?></a></li>
  ...
  <div class="container">
    <div class="row service-titre">
      <div class=" col-lg-6 col-md-6 col-sm-12 col-xs-12">
        <h3><?php echo $lang['coiffure_cap']; ?>
        </h3>
       </div>   
       <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 right-arrow pull-right"><a class="a-link pull-right" href="espace-prive-coiffures.php"><?php echo $lang['Voir_catalogue']; ?> </a></div>   
    </div>
    <div class="row">
                ...
                <div class="panel panel-default">
                  <div class="panel-heading">
                    <h4 data-toggle="collapse" data-parent="#accordion" href="#collapse1" class="panel-title expand">
                      ...
                      <a href="#" ><?php echo $lang['coiffure_cap']; ?></a>
                    </h4>
                  </div>
