...
<title><?php echo $lang['titre_prive_prix_soins']; ?></title>
<!-- Bootstrap -->
      ...
      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 slogan">
        <div class="row">
          ...
          <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
            <div class="top-btn">
               <a href="espace-prive-Soins-Esthetique-prix.php?lang=fr"><img class="img-fluid" src="../images/francais-flag.png" alt="Francais" title="Francais"></a>&nbsp;&nbsp;
            <a href="espace-prive-Soins-Esthetique-prix.php?lang=en"><img class="img-fluid" src="../images/anglais-flag.png" alt="English" title="English"></a>  

              <!-- 
            <a  href="espace-prive-Soins-Esthetique-prix.php?lang=fr" style="color: #ffffff;font-family: 'Work Sans', sans-serif; "><b>FR</b></a>
              <a  href="espace-prive-Soins-Esthetique-prix.php?lang=en" style="color: #ffffff;font-family: 'Work Sans', sans-serif; "><b>Eng</b></a>
          ...
          <ul >
              ...
              <li><a href="#" title="Blog" ><?php echo $lang['Offres_cap']; ?></a>
                <ul>
                  ...
                  <li class="active" ><a href="espace-prive-Soins-Esthetique-prix.php" title="prix soins & Esthetiques" class="animsition-link"><?php echo $lang['Liste_Prix_Soins']; ?></a></li>
                </ul>
              </li>
  ...
  <div class="container">
    <div class="row service-titre">
      <div class=" col-lg-6 col-md-6 col-sm-12 col-xs-12">
       <h3><?php echo $lang['soins_esthetiques_cap']; ?></span>
       </h3>
       </div>   
       <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 right-arrow pull-right"><a class="a-link pull-right" href="espace-prive-Soins-Esthetique.php"><?php echo $lang['Voir_catalogue']; ?></a></div>   
    </div>
    <div class="row">
      <div class="container">
        <section class="images-evernice slider">
          <div class="slide"><img width="400" src="../images/Evernice_images/Soins_prive/image1.jpg"></div>
          <div class="slide"><img width="400" src="../images/Evernice_images/Soins_prive/image2.jpg"></div>
          <div class="slide"><img width="400" src="../images/Evernice_images/Soins_prive/image3.jpg"></div>
          <div class="slide"><img width="400" src="../images/Evernice_images/Soins_prive/image4.jpg"></div>
          <div class="slide"><img width="400" src="../images/Evernice_images/Soins_prive/image5.jpg"></div>
          <div class="slide"><img width="400" src="../images/Evernice_images/Soins_prive/image6.jpg"></div>
          <div class="slide"><img width="400" src="../images/Evernice_images/Soins_prive/image7.jpg"></div>
        </section>
      </div>
    </div>
                ...
                <div class="panel panel-default">
                  <div class="panel-heading">
                    <h4 data-toggle="collapse" data-parent="#accordion" href="#collapse1" class="panel-title expand">
                      ...
                      <a href="#" ><?php echo $lang['soins_esthetiques_cap']; ?></a>
                    </h4>
                  </div>
                  <div id="collapse1" class="panel-collapse collapse">
                    <div class="panel-body">
                      <ul class="list-unstyled liste-prix">
                       <center><?php echo $lang['Liste_des_prix2']; ?> 
                      </ul>
                    </div>
